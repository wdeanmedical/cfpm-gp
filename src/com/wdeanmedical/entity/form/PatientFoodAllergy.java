...
@Entity
@Table(name = "patient_food_allergy")
public class PatientFoodAllergy extends BaseEntity implements Serializable {
  
  private static final long serialVersionUID = -918500786990329761L;
