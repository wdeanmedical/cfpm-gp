...
@Entity
@Table(name = "edt_registration_form")
@Inheritance(strategy = InheritanceType.JOINED)
public class EDTRegistration extends WDMForm implements Serializable {
  private static final long serialVersionUID = 209725932498850937L;
  public static String[] PHI_FIELDS = new String[] {};
  public static final String NAME = "edt_registration";
  ...
  public EDTRegistration() {
    this.name = EDTRegistration.NAME;
  }
