...
@Entity
@Table(name = "parent_cbc")
@Inheritance(strategy = InheritanceType.JOINED)
public class ParentCBC extends WDMForm implements Serializable {
  private static final long serialVersionUID = 8587707096786493975L;
  public static final String NAME = "parent_cbc";
  ...
  @Column(name = "repeat_grade")
  public String getRepeat() { return repeat; }
  public void setRepeat(String repeat) { this.repeat = repeat; }

  @Column(name = "repeat_grade_desc")
  public String getRepeatDesc() { return repeatDesc; }
  public void setRepeatDesc(String repeatDesc) { this.repeatDesc = repeatDesc; }
